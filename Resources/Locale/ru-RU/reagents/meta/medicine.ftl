...
# ADT-Tweak: Реагенты для лечения церебральных травм
reagent-name-mannitol = маннитол
reagent-desc-mannitol = Лечит лёгкую церебральную травму.
reagent-effect-cure-cerebral-trauma = Лечит лёгкую церебральную травму
reagent-effect-cure-serious-cerebral-trauma = Лечит серьёзную церебральную травму
reagent-name-psicodine = псикодин
reagent-desc-psicodine = Лечит серьёзную церебральную травму. Подавляет тревожность и прочие различные формы психических расстройств. Передозировка вызывает галлюцинации и незначительные повреждения токсинами.
