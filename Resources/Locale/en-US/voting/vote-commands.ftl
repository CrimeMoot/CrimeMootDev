...
cmd-customvote-help = Usage: customvote <title> <option1> <option2> [option3...] [true/false]
...
cmd-customvote-on-finished-win-weighted = Vote (weighted random): '{$title}' has finished: {$winner} wins!
